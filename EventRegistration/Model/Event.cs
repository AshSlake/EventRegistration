...
namespace EventRegistration.Model
{
    public class Event
    {
        ...
        {
            // Calculate the total number of the days of the event
            get => (this.endData - this.startData).Days + 1;
        ...
        public string dataStartEvent
        {
            ...
            get => this.startData.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
        }

        public string dataEndEvent
        {
            // Format the end date of the event
            get => this.endData.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
        }
